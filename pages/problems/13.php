...
<body style="background-color: black">
	...
	<section class='problem_description'>
		<p>
			Let $X=\displaystyle\sum\limits_{k=0}^{347}{ \dbinom{700}{k} \left( \displaystyle\sum\limits_{j=0}^{347-k}{\dbinom{700-k}{j}\dbinom{700-k-j}{347-k-j}} \right)}.$
			<p>
				If $p_{1}^{a_{1}}p_{2}^{a_{2}}p_{3}^{a_{3}}...p_{n}^{a_{n}}$ is a prime factorization of $\dfrac{X}{\dbinom{700}{347}},$ what is $(p_{1})(a_{1})(p_{2})(a_{2})...(p_{n})(a_{n})?$
			</p>
	   </p>
	</section>
	<section>
